# Домашние задания за 3 и 4 месяц
...
- [ ] [20. Архитектурные паттерны iOS: MVC, MVP, MVVM, Clean(VIPER)](Task-20/)
...
- [ ] [24. Работаем с сетью: HTTP и URLSession, JSON, Разбираем работу с сетью с готовыми библиотеками и решениям: Alamofire, Moya](Task-24/)
- [ ] [25. Core Data](Task-25/)
- [ ] [26. User Defaults, работа с файловой системой](Task-26/)
